...
for i in range(1, synergies_considered):
    ...
    # Trace Plots
    mp.sel_primitive_trace(data_selection_non, syn_selection_non, "M5 PreDTX Non-pertubation Synergy {} at 0.100m/s".format(i))
    mp.sel_primitive_trace(data_selection_per, syn_selection_per, "M5 PreDTX with pertubation Synergy {} at 0.100m/s".format(i))
    mp.sel_primitive_trace(data_selection_non_post, syn_selection_non_post, "M5 PostDTX Non-pertubation Synergy {} at 0.100m/s".format(i))
