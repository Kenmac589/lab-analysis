...
plt.title("Synegies for postDTX at 0.100 ms with perturbation")
plt.savefig('postdtx-100-per.png', dpi=300)
...
plt.tight_layout()
fig.suptitle('Muscle Synergies 0.100 with perturbation postDTX', fontsize=16, fontweight='bold')
plt.subplots_adjust(top=0.9)
plt.savefig('100-per-postDTX.png', dpi=300)
