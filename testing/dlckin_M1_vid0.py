...
df, bodyparts, scorer = dlck.load_data(
    "./1yrDTRnoRosa-M1-19102023_000000DLC_resnet50_1yrDTRnoRosa-preDTXJan31shuffle1_1030000.h5"
)
# dftest = pd.read_csv(
#     "./1yrDTRnoRosa-M2-preDTX-23102023_000000DLC_resnet50_1yrDTRnoRosa-preDTXJan31shuffle1_1030000.csv",
#     header=[0, 1, 2],
# )
