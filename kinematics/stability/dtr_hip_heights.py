...
dtr_pre_non_hiph = ls.hip_height(
    dtrpost_6non, toey="25 toey (cm)", hipy="17 Hipy (cm)", manual=False
)
dtr_pre_per_hiph = ls.hip_height(
    dtrpost_6per, toey="25 toey (cm)", hipy="17 Hipy (cm)", manual=False
)
dtr_pre_sin_hiph = ls.hip_height(
    dtrpost_6sin, toey="25 toey (cm)", hipy="17 Hipy (cm)", manual=True
)

print(f"DTR M7 non Hip automatically {dtr_pre_non_hiph}")
print(f"DTR M7 per Hip automatically {dtr_pre_per_hiph}")
print(f"DTR M7 sin Hip manually {dtr_pre_sin_hiph}")
