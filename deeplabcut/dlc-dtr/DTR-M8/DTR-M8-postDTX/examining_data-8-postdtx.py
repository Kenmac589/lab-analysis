...
df, bodyparts, scorer = dlck.load_data(
    "./DTR-M8-postDTX_000000DLC_resnet50_dtr_update_postdtxApr22shuffle1_800000_filtered.h5"
)
config_path = "/Users/kenzie_mackinnon/sync/lab-analysis/deeplabcut/dlc-dtr/dtr_update_postdtx-kenzie-2024-04-22/config.yaml"

print(df.head())

# Interactive Visualizer
# non_perturbation_input = "./DTR-M8-postDTX_000000DLC_resnet50_dtr_update_postdtxApr22shuffle1_800000_filtered.h5"
...
plt.plot(lhl_filtered)
plt.plot(rhl_filtered)
plt.plot(lfl_filtered)
plt.plot(rfl_filtered)
# plt.plot(com_np)
