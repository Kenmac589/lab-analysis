...
# Read in M1 data
M1_non_perturbation = pd.read_csv("./M1-non-100.csv", header=0)
M1_perturbation = pd.read_csv("./M1-per-100.csv", header=0)
M1_sinusodal = pd.read_csv("./M1-per-300.csv", header=0)

# Read in M2 data
M2_non_perturbation = pd.read_csv("./M2-non-100.csv", header=0)
M2_non_perturbation_high = pd.read_csv("./M2-non-200.csv", header=0)
M2_perturbation_low = pd.read_csv("./M2-per-100.csv", header=0)

# Read in M3 data
M3_non_perturbation = pd.read_csv("./M3-non-100.csv", header=0)
...
M1_non_low_step_duration, M1_non_low_treadmill = step_duration(M1_non_perturbation)
M1_non_high_step_duration, M1_non_high_treadmill = step_duration(M1_non_perturbation_high)
M1_per_low_step_duration, M1_per_low_treadmill = step_duration(M1_perturbation)

M2_non_low_step_duration, M2_non_low_treadmill = step_duration(M2_non_perturbation)
...
M3_non_low_step_duration, M3_non_low_treadmill = step_duration(M3_non_perturbation)
