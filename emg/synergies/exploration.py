...
motor_p_filtered = sp.ndimage.median_filter(motor_p_data, size=2, cval=1, mode='constant')
motor_p_df = pd.DataFrame(motor_p_filtered, columns=('Synergy 1', 'Synergy 2', 'Synergy 3', 'Synergy 4', 'Synergy 5', 'Synergy 6', 'Synergy 7'))
motor_p_df.plot(subplots=True, title="WT Primitives direct from NMF with median filter", legend=False)
