...
print("Average step duration for M1 at speed 0.100 m/sec:", np.mean(M1_non_low_step_duration), "standard deviation:", np.std(M1_non_low_step_duration))
print("Average step duration for M1 at speed 0.300 m/sec:", np.mean(M1_non_high_step_duration), "standard deviation:", np.std(M1_non_high_step_duration))
print("Average step duration for M1 at speed 0.100 m/sec:", np.mean(M1_per_low_step_duration), "standard deviation:", np.std(M1_per_low_step_duration))
print("Average step duration for M1 at speed 0.300 m/sec:", np.mean(M1_per_high_step_duration), "standard deviation:", np.std(M1_per_high_step_duration))
print()
print("Average step duration for M2 at speed 0.100 m/sec:", np.mean(M2_non_low_step_duration), "standard deviation:", np.std(M2_non_low_step_duration))
print("Average step duration for M2 at speed 0.200 m/sec:", np.mean(M2_non_high_step_duration), "standard deviation:", np.std(M2_non_high_step_duration))
print("Average step duration for M2 at speed 0.100 m/sec:", np.mean(M2_per_low_step_duration), "standard deviation:", np.std(M2_per_low_step_duration))
print()
