...
# Load Data
data = pd.read_csv("./norm-emg-smooth-020.csv", header=None)
A = data.to_numpy()
...
plt.tight_layout()
fig.suptitle('Muscle Synergies (CoM-M3-WT-20220420-v3_norm-emg-smooth-020)', fontsize=16, fontweight='bold')
plt.subplots_adjust(top=0.9)
plt.savefig('CoM-M3-WT-20220420-v3-synergies_norm-emg-smooth-020.png', dpi=300)
